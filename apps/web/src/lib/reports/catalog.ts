...
export const REPORT_CATEGORIES: ReportCategoryDef[] = [
  ...
  },
  {
    ...
    reports: [
      ...
      { slug: "reconciliation", title: "Financial Reconciliation", description: "Billed, collected, owed and paid ahead — the four figures side by side.", filters: [] },
      { slug: "discounts", title: "Discount Report", description: "Months charged below the student's fee, with the reason given.", filters: ["className", "section"] },
      { slug: "waivers", title: "Waiver Report", description: "Months cleared in full, with the reason given.", filters: ["className", "section"] },
      { slug: "payment-methods", title: "Payment Method Report", description: "What arrived as cash, EVC, bank or other.", filters: ["dateFrom", "dateTo"] },
