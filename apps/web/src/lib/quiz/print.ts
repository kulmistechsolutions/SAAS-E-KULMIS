...
<style>
  body{font-family:Georgia,serif;padding:40px;color:#0f172a;max-width:720px;margin:0 auto}
  ...
  .score{font-size:32px;font-weight:700;text-align:center;color:#0f766e;margin:24px 0}
</style></head><body>
  <div class="head">
    <h1>${SCHOOL.name}</h1>
