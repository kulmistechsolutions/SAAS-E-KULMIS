...
import { apiTeacherPortalStudents } from "@/lib/teacher-portal/api";
...
export default function TeacherPortalStudentsList() {
  ...
  useEffect(() => {
    void apiTeacherPortalStudents()
      .then((rows) => setStudents(rows as MyStudent[]))
      .catch((e) =>
        toast(e instanceof Error ? e.message : "Could not load students", "error"),
      )
