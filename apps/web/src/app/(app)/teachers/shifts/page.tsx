...
/**
 * Teacher Shift management — the same school-wide shift list Attendance Shift
 * Management edits (a teacher's shift and a student's attendance shift are
 * intentionally the same named sessions, e.g. "Morning"), surfaced here too
 * so an admin managing teachers never has to leave the Teachers section to
 * add a shift.
 */
export default function TeacherShiftsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <ArrowLeft className="h-4 w-4" /> {t("teachersShifts.backToTeachers")}
      </Link>

      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <h1 className="text-2xl font-bold">{t("teachersShifts.title")}</h1>
          <p className="mt-1 text-sm text-muted-foreground">
            {t("teachersShifts.description")}
          </p>
        </div>
