...
const CARDS: {
  ...
  {
    key: "totalExams",
    label: "examinationsSummaryCards.totalExams",
    icon: FileText,
  ...
  {
    key: "activeExams",
    label: "examinationsSummaryCards.activeExams",
    icon: BookOpen,
  ...
  {
    key: "draftExams",
    label: "examinationsSummaryCards.draftExams",
    icon: ClipboardList,
  ...
  {
    key: "lockedExams",
    label: "examinationsSummaryCards.lockedExams",
    icon: Lock,
  ...
  {
    key: "publishedExams",
    label: "examinationsSummaryCards.publishedExams",
    icon: Send,
  ...
  },
  {
    ...
    label: "examinationsSummaryCards.pendingTeacherSubmissions",
    icon: ClipboardList,
  ...
  },
  {
    ...
    label: "examinationsSummaryCards.completedTeacherSubmissions",
    icon: CheckCircle2,
  ...
  {
    key: "examGroups",
    label: "examinationsSummaryCards.examGroups",
    icon: PieChart,
  ...
  },
  {
    ...
    label: "examinationsSummaryCards.resultPublications",
    icon: Send,
