...
const FEE_CHILDREN: NavChild[] = [
  ...
  { label: "nav.freeStudents", href: "/finance/free-students" },
  ...
  { label: "nav.schoolDebts", href: "/finance/debts" },
  { label: "nav.reports", href: "/reports/fees" },
    ...
    <div className="flex h-full flex-col bg-[#111a2e] text-slate-300">
      ...
      >
        ...
        >
          ...
          {!collapsed && t("layoutSidebar.systemStatus")}
        </div>
        {!collapsed && (
          <>
